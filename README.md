<div align="center">
  <h1>Salut ! Moi, c'est Arya.</h1>
  <p><sub><code>vahm (ILLUSION)</code></sub></p>
  <img src="https://hitscounter.dev/api/hit?url=https%3A%2F%2Fgithub.com%2Faryainjas%2Faryainjas&label=&icon=github&color=%23198754&message=&style=flat&tz=UTC" alt="Badge" />
</div>

---

CS student. Somewhere between math, cryptography, and machine learning.

Currently: making blockchains do things they weren't supposed to.

Also quietly obsessed with what happens when models meet messy data.
